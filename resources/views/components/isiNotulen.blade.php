        ...
        <div class="space-y-4">
            ...
            <div class="relative">
                <input type="text" 
                       ...
                       value="{{ old('pimpinan_rapat_ttd', $agenda->notulen->pimpinan_rapat_ttd ?? ($lastPimpinanRapat ?? '')) }}" 
                       class="w-full px-4 py-4 pl-12 bg-white border-2 border-gray-200 rounded-lg focus:outline-none focus:ring-0 focus:ring-black focus:border-black transition-all duration-200 hover:border-black text-gray-800 font-medium shadow-sm" 
            ...
            <p class="text-sm text-gray-600 bg-purple-50/50 p-4 rounded-lg border border-purple-200/50 flex items-start">
                <svg class="w-4 h-4 mr-2 text-black mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                </svg>
