...
<x-layout>
        ...
        <div id="popup-alert-error" class="fixed top-[10%] left-1/2 z-50 popup-alert">
            <div class="flex items-center border-l-4 border-red-500 bg-white p-4 rounded-lg shadow-lg transition-all duration-300 ease-in-out transform" role="alert">
                ...
                <button type="button" class="group ml-4" onclick="hideAlertError()">
                    <svg class="h-5 w-5 stroke-red-500 group-hover:stroke-red-700 transition-colors duration-200" fill="none" viewBox="0 0 24 24" stroke-width="2">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M6 18L18 6M6 6l12 12"></path>
                    </svg>
                </button>
            </div>
    ...
    @if($errors->any())
        @foreach($errors->all() as $index => $error)
            <div id="popup-alert-validation-{{ $index }}" class="fixed top-[{{ 10 + ($index * 8) }}%] left-1/2 z-50 popup-alert">
                <div class="flex items-center border-l-4 border-red-500 bg-white p-4 rounded-lg shadow-lg transition-all duration-300 ease-in-out transform" role="alert">
                    <div class="flex-shrink-0 mr-3">
                        <svg class="h-6 w-6 text-red-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v3.75m-9.303 3.376c-.866 1.5.217 3.374 1.948 3.374h14.71c1.73 0 2.813-1.874 1.948-3.374L13.949 3.378c-.866-1.5-3.032-1.5-3.898 0L2.697 16.126zM12 15.75h.007v.008H12v-.008z" />
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-10 py-2">        
                ...
                <div class="mb-10">
                    ...
                    <div class="mt-6 h-[calc(100vh-280px)] overflow-hidden">
                        ...
                        <div x-show="activeTab === 'notulen'" role="tabpanel" class="h-full flex flex-col bg-purple-50 rounded-lg border-2 border-dashed border-purple-200" x-transition>
