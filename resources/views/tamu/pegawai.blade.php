...
<body>
    <div class="container">
        ...
        <!-- Form Card -->
        <div class="rounded-3xl shadow-2xl p-8 bg-gradient-to-br from-white/90 to-white/70 backdrop-blur-xl border border-white/30" x-data="pegawaiForm()" style="background: linear-gradient(145deg, rgba(255,255,255,0.95) 0%, rgba(255,255,255,0.85) 100%); box-shadow: 0 25px 50px rgba(0,0,0,0.1), inset 0 1px 0 rgba(255,255,255,0.6);">
