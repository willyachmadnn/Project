        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            <div class="bg-white rounded-xl shadow-lg p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-bold text-gray-900">{{ $tamu->count() }}</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-xl shadow-lg p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        <p class="text-sm font-medium text-gray-600">Pegawai</p>
                        <p class="text-2xl font-bold text-gray-900">{{ $tamu->where('NIP', 'not like', 'NP%')->count() }}</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-xl shadow-lg p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        <p class="text-sm font-medium text-gray-600">Non-Pegawai</p>
                        <p class="text-2xl font-bold text-gray-900">{{ $tamu->where('NIP', 'like', 'NP%')->count() }}</p>
                    </div>
                </div>
            </div>
        </div>
